			   		...
			   		<?php foreach ($post as $key): ?>
			   			...
			   			<div class="post-content">
			   				...
			   				<div class="col-md-12 post-options">
			   					<div class="posted-by"><?=$this->post_m->posted_by($key->user_id);?> | <?=date('F d, Y',strtotime($key->date_posted));?> | <div class="fb-share-button" data-href="<?=site_url("c=site&f=read&p=$site_path&i=$key->slug");?>" data-layout="button_count" data-size="small" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?=site_url("c=site&f=read&p=$site_path&i=$key->slug");?>&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></div>
			   				</div>
			   			</div>
